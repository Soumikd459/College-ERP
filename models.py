...
#( verbose_name_plural attribute allows you to specify the plural name of the model 
#for use in human-readable display contexts, such as in the Django admin interface.)
    def __str__(self):
